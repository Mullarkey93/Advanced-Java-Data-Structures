...
public class TestTask2 {
	...
	public static void insertData() {
		executeStatement(
				new Insert(
						...
						new String[] {"Remjlkjlkjkjlkj", "rem.collier@ucd.ie"}
				)
		);
		executeStatement(
				new Insert(
	...
	public static void testOperators() {
		...
		executeStatement(new Select("contact", new String[] { "id", "name" }, new Like("name", "%Rem")));
		executeStatement(new Select("contact", new String[] { "id", "name" }, new Like("name", "jlkj%")));
		executeStatement(new Select("contact", new String[] { "id", "name" }, new Like("name", "%lkj%")));
